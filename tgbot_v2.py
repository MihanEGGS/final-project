...
def tit_for_tat(player_choice, response):
    ...
    bots_choice = '1' if player_previous_choice in [None, '1'] else '2'
    if player_choice == bots_choice and player_choice == '1':
        bot_points+= 3
        player_points += 3
    elif player_choice != bots_choice and bots_choice == '1':
        bot_points+= 0
        player_points += 5
...
async def rules(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("RULEEEEEEEEEEEEZ"+'\n'+"You are playing with bot, and in your first move you can either cooperate or cheat your bot opponent"
                                    ...
                                    + '\n'+ "---If one of you choose to cheat, that player, who cheats, gains 5 points and second playuer gains nothing "
...
async def matches(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("Type /matches to recieve tournament bracket")
